// src/templates/Bakery/BakeryContact.tsx
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            ...
                            >
                                <EditableText elementId="bk_contact_info_title" defaultText="Contacto" tag="span" />
                            </h3>
                                ...
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        <p style={{ color: sectionColors.bodyTextColor }}>
                                            <EditableText elementId="bk_contact_phone" defaultText="+54 11 4567-8900" tag="span" />
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        <p style={{ color: sectionColors.bodyTextColor }}>
                                            <EditableText elementId="bk_contact_email" defaultText="pan@kernelize.com" tag="span" />
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        <p style={{ color: sectionColors.bodyTextColor }}>
                                            <EditableText elementId="bk_contact_address" defaultText="Av. Rivadavia 4567, Almagro" tag="span" />
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        <p style={{ color: sectionColors.bodyTextColor }}>
                                            <EditableText elementId="bk_contact_hours" defaultText="Lun-Dom 7:00 - 20:00" tag="span" />
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            {isSubmitted ? (
                                <div className="text-center py-12">
                                    ...
                                    <h3
                                        ...
                                        style={{ color: sectionColors.featuresTitleColor }}
                                    >
                                        <EditableText elementId="bk_success_title" defaultText="¡Consulta enviada!" tag="span" />
                                    </h3>
                                    <p
                                        className="mb-8"
                                        style={{ color: sectionColors.bodyTextColor }}
                                    >
                                        <EditableText elementId="bk_success_message" defaultText="Te contactaremos a la brevedad." tag="span" />
                                    </p>
                                    <button
                                ...
                                <>
                                    <h3
                                        ...
                                        style={{ color: sectionColors.featuresTitleColor }}
                                    >
                                        <EditableText elementId="bk_form_title" defaultText="Dejanos tu consulta" tag="span" />
                                    </h3>
                                    <form onSubmit={handleSubmit} className="space-y-4">
                                        <div className="grid md:grid-cols-2 gap-4">
                                            <div>
                                                <label
                                                    ...
                                                    style={{ color: sectionColors.bodyTextColor }}
                                                >
                                                    <EditableText elementId="bk_form_name" defaultText="Nombre *" tag="span" />
                                                </label>
                                                <input
                                            ...
                                            <div>
                                                <label
                                                    ...
                                                    style={{ color: sectionColors.bodyTextColor }}
                                                >
                                                    <EditableText elementId="bk_form_email" defaultText="Email *" tag="span" />
                                                </label>
                                                <input
                                        ...
                                        <div>
                                            <label
                                                ...
                                                style={{ color: sectionColors.bodyTextColor }}
                                            >
                                                <EditableText elementId="bk_form_phone" defaultText="Teléfono" tag="span" />
                                            </label>
                                            <input
                                        ...
                                        <div>
                                            <label
                                                ...
                                                style={{ color: sectionColors.bodyTextColor }}
                                            >
                                                <EditableText elementId="bk_form_message" defaultText="Mensaje *" tag="span" />
                                            </label>
                                            <textarea
