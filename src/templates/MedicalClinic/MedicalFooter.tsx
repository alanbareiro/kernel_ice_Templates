                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center space-x-2">
                            <HeartPulse className="w-8 h-8" style={{ color: sectionColors.buttonPrimaryBackground }} />
                            <span className="text-2xl font-bold">
                                ...
                                <span className="ml-1 font-light" style={{ color: sectionColors.buttonPrimaryBackground }}>
                                    <EditableText elementId="md_footer_brand_2" defaultText="Salud" tag="span" />
                                </span>
                            </span>
                        </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="#doctors" className="transition-colors" style={{ color: sectionColors.footerLinkColor }}>
