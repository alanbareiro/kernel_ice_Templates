            ...
            <div className="container-custom">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {testimonials.map((testimonial) => (
                        <div key={testimonial.id} className="bg-stone-50 dark:bg-stone-800/50 rounded-2xl p-8 shadow-lg">
                            ...
                            <p className="text-lg text-stone-700 dark:text-stone-300 italic mb-6">
                                "<EditableText
