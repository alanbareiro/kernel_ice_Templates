// src/templates/Startup/StartupHeader.tsx
...
const StartupHeader: React.FC = () => {
    ...
    const navItems = [
        { id: 'st_nav_home', label: 'Inicio', href: '#home', visible: true },
        { id: 'st_nav_problem', label: 'Problema', href: '#problem', visible: true },
        { id: 'st_nav_solution', label: 'Solución', href: '#solution', visible: true },
        { id: 'st_nav_team', label: 'Equipo', href: '#team', visible: true },
        { id: 'st_nav_contact', label: 'Contacto', href: '#contact', visible: true },
    ];
    ...
    const handleLogoClick = (e: React.MouseEvent) => {
        if (config.isEditing) {
            e.preventDefault();
            const logoElement = document.getElementById('st_logo');
            ...
            <div className="container-custom px-6 py-4">
                <div className="flex items-center justify-between">
                    <a href="/" onClick={handleLogoClick} className="flex items-center space-x-3 group">
                        <div id="st_logo" data-element-id="st_logo">
                            <EditableImage
                                elementId="st_logo"
                                defaultImage=""
                                alt="Kernelize Startup"
                    ...
                    <nav className="hidden md:flex items-center space-x-8">
                        ...
                        >
                            <EditableText elementId="st_header_cta" defaultText="Probar demo" tag="span" />
                        </a>
                        <ThemeToggle />
                    </nav>
