...
const FoodTruckHeader: React.FC = () => {
    ...
    const navItems = [
        ...
        { id: 'ft_nav_menu', label: 'Menú', href: '#menu', visible: true },
        { id: 'ft_nav_location', label: 'Dónde estamos', href: '#location', visible: true },
        { id: 'ft_nav_contact', label: 'Contacto', href: '#contact', visible: true },
    ];
    ...
    const handleLogoClick = (e: React.MouseEvent) => {
        if (config.isEditing) {
            e.preventDefault();
            const logoElement = document.getElementById('ft_logo');
