...
const AgencyHeader: React.FC = () => {
    ...
    const navItems = [
        ...
        { id: 'ag_nav_services', label: 'Servicios', href: '#services', visible: true },
        { id: 'ag_nav_cases', label: 'Casos de éxito', href: '#cases', visible: true },
        { id: 'ag_nav_team', label: 'Equipo', href: '#team', visible: true },
        { id: 'ag_nav_contact', label: 'Contacto', href: '#contact', visible: true },
    ];
    ...
    const handleLogoClick = (e: React.MouseEvent) => {
        if (config.isEditing) {
            e.preventDefault();
            const logoElement = document.getElementById('ag_logo');
