...
const CleaningAbout: React.FC = () => {
    ...
    const stats = [
        { icon: <Calendar className="w-6 h-6" />, valueId: 'cl_about_stat_1_value', valueDefault: '10+', labelId: 'cl_about_stat_1_label', labelDefault: 'Años' },
        ...
        { icon: <Sparkles className="w-6 h-6" />, valueId: 'cl_about_stat_3_value', valueDefault: '15000+', labelId: 'cl_about_stat_3_label', labelDefault: 'Servicios' },
        { icon: <Award className="w-6 h-6" />, valueId: 'cl_about_stat_4_value', valueDefault: '5', labelId: 'cl_about_stat_4_label', labelDefault: 'Premios' },
    ];
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative group order-2 lg:order-1">
                        ...
                        <div className="relative z-10 overflow-hidden rounded-2xl shadow-2xl">
                            <EditableImage elementId="cl_about_image" defaultImage="" alt="Nuestro equipo" className="w-full h-auto object-cover" category="cleaning" />
                            <div className="absolute inset-0 bg-gradient-to-t from-sky-900/80 via-transparent to-transparent" />
                            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                                <h3 className="text-2xl font-bold mb-2"><EditableText elementId="cl_founder_name" defaultText="Carlos Rodríguez" tag="span" /></h3>
                                <p className="opacity-90"><EditableText elementId="cl_founder_title" defaultText="Fundador" tag="span" /></p>
                            </div>
                        </div>
                    </div>
