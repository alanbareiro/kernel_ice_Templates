                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="text-2xl font-bold">
                                ...
                                <EditableText elementId="ar_footer_brand_2" defaultText="Arquitectura" tag="span" className="ml-1 font-light" />
                            </span>
                        </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="#projects" className="text-white/70 hover:text-white transition-colors">
