...
const ArchitectureHeader: React.FC = () => {
    ...
    const navItems = [
        { id: 'ar_nav_home', label: 'Inicio', href: '#home', visible: true },
        { id: 'ar_nav_projects', label: 'Proyectos', href: '#projects', visible: true },
        { id: 'ar_nav_services', label: 'Servicios', href: '#services', visible: true },
        { id: 'ar_nav_team', label: 'Equipo', href: '#team', visible: true },
        { id: 'ar_nav_contact', label: 'Contacto', href: '#contact', visible: true },
    ];
    ...
    const handleLogoClick = (e: React.MouseEvent) => {
        if (config.isEditing) {
            e.preventDefault();
            const logoElement = document.getElementById('ar_logo');
